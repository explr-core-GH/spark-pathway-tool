...
export const Route = createFileRoute("/educator/admin/internships/")({
  head: () => ({
    meta: [
      { title: "Internship Programs — EXPLR Admin" },
      {
        name: "description",
        content: "Manage EXPLR internship offerings, visibility, educator assignments, and funder reports.",
      },
      { property: "og:title", content: "Internship Programs — EXPLR Admin" },
      {
